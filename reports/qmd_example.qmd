...
![](../results/horse_pops_plot.png){#fig-1 width=60%}
...
Additionally, note that in @tbl-horses we consider the sample standard deviation of the number of horses during the same time span as @fig-1.

![](../results/horse_pops_plot_largest_sd.png){#fig-2 width=60%}
